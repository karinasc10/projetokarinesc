<?php 
    ...
    if(isset($_SESSION['usuario_id'])){
        ...
        $outgoing_id = $_SESSION['usuario_id'];
        $incoming_id = mysqli_real_escape_string($conn, $_POST['incoming_id']);
        $output = "";
        $sql = "SELECT * FROM messages LEFT JOIN usuarios ON usuarios.id = messages.outgoing_msg_id
