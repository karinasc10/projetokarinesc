...
<body>
    ...
    <div id="conteudo">
    <section id="curso-ambiental" class="bg-light py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h3 class="text-success">Curso Técnico Ambiental</h3>
                    <p class="lead">Prepare-se para fazer a diferença no mundo natural. Nosso curso técnico ambiental oferece uma educação abrangente para aqueles apaixonados por conservação e sustentabilidade ambiental.</p>
                    <p>Nossos alunos se tornam defensores do meio ambiente, adquirindo habilidades essenciais para entender, preservar e gerenciar os recursos naturais do planeta.</p>
                    <p>Com a crescente preocupação com questões ambientais em todo o mundo, este curso oferece a oportunidade de se tornar um líder na proteção do nosso planeta.</p>
                    <ul class="list-unstyled">
                        <li><i class="fas fa-check text-success"></i> Estudo das ciências ambientais e ecologia</li>
                        <li><i class="fas fa-check text-success"></i> Conservação da biodiversidade e gestão de recursos naturais</li>
                        <li><i class="fas fa-check text-success"></i> Resolução de problemas ambientais e políticas de sustentabilidade</li>
                        <li><i class="fas fa-check text-success"></i> Práticas de campo e monitoramento ambiental</li>
                    </ul>
                    <p>Se você é apaixonado pela natureza e deseja contribuir para um futuro mais sustentável, nosso curso técnico ambiental é a escolha perfeita.</p>
                </div>
                <div class="col-lg-6">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTci9J3XxN1aDFKyXCKan6_-HthLdbpTM2OsQ&usqp=CAU" class="img-fluid" alt="Curso Técnico Ambiental">
                </div>
            </div>
        </div>
    </section>
